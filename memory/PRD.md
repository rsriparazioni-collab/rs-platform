...
- Verifiche finali: 53/53 pytest (test_alerts aggiornato con chiave sotto_scorta), export XLSX validi (PK), KPI WhatsApp renderizzato, nessun errore compilazione frontend
